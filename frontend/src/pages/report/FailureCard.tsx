...
import { TrackInDialog } from './TrackedInBadge'
          ...
          <CardContent className="space-y-4 border-t border-border-muted pt-4">
            ...
            {trackedIn[repKey]?.tracked_in_url && (
              <div className="pl-16 space-y-1">
                ...
                >
                  {trackedIn[repKey].tracked_in_type === 'github' ? (
                    <svg className="h-3.5 w-3.5 shrink-0 text-text-tertiary" viewBox="0 0 16 16" fill="currentColor"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z" /></svg>
                  ) : trackedIn[repKey].tracked_in_type === 'jira' ? (
                    <svg className="h-3.5 w-3.5 shrink-0 text-text-tertiary" viewBox="0 0 24 24" fill="currentColor"><path d="M11.571 11.513H0a5.218 5.218 0 0 0 5.232 5.215h2.13v2.057A5.215 5.215 0 0 0 12.593 24V12.518a1.005 1.005 0 0 0-1.022-1.005zM5.024 5.769a5.218 5.218 0 0 0 5.228 5.215h2.133v2.057a5.215 5.215 0 0 0 5.229 5.213V6.774a1.005 1.005 0 0 0-1.022-1.005H5.024zM17.615 0a5.218 5.218 0 0 0 5.229 5.215V1.005A1.005 1.005 0 0 0 21.822 0h-4.207z" /></svg>
                  ) : (
